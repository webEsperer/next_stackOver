...
const Navbar = () => {
  return (
    <nav className="flex-between background-light900_dark200 shadow-light-300 dark:shadow-none text-dark-100 dark:text-light-900 z-50 gap-5 p-6 sm:px-12 fixed w-full">
